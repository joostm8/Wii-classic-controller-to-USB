...
void Joystick_::begin(bool initAutoSendState)
{
	...
	usbhid_start(customHidReportDescriptor, hidReportDescriptorSize);
...
void Joystick_::sendState()
{
	...
	usbd_ep_write_packet(usbd_dev,0x81,data,_hidReportSize);

	/*
	In stm32bluepill repo Diego does this:
